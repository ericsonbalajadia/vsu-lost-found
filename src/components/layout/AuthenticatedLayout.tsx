  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-surface-container-lowest border-t border-outline-variant/10 md:hidden flex justify-around items-center h-16 px-2">
        ...
        {/* Report (emphasised, icon only, overlapping) */}
        <Link
          to="/report"
          className="flex items-center justify-center w-14 h-14 rounded-full bg-primary text-white shadow-xl shadow-primary/40 hover:scale-105 active:scale-95 transition-transform -mt-6"
