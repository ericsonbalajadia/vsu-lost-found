...
export default function SignUp() {
  ...
  return (
    <main
      id="main-content"
      className="flex flex-col md:flex-row h-screen overflow-hidden bg-background"
    >
        ...
        <div className="relative z-20 flex flex-col justify-start items-start h-full px-16 lg:px-24 max-w-3xl pt-98">
          ...
          <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl border border-white/20 max-w-md">
            <p className="body-lg text-white">
              Access the community‑driven lost and found platform. Secure, efficient, and trusted by
              users everywhere.
            </p>
          </div>
        </div>
        <div className="absolute bottom-8 left-16 z-20">
          <p className="label-sm text-white/80 uppercase tracking-widest">
      ...
      <section className="flex-1 bg-white flex flex-col justify-center items-center p-8 md:p-16 relative">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center justify-center md:justify-start gap-2 mb-8">
            ...
            <span className="text-on-surface font-headline font-extrabold text-xl tracking-tighter text-yellow-500">
              FoundPath
            </span>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleEmailSignUp}>
            ...
            <div className="space-y-2">
              <label
                className="block text-xs font-semibold tracking-wide text-[#434652] ml-1"
                htmlFor="name"
              >
                Full Name
              </label>
          ...
          <div className="relative my-10">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white px-4 text-xs font-semibold tracking-wide text-[#434652]">
                OR
              </span>
            </div>
          </div>
          ...
          <footer className="mt-12 text-center space-y-4">
            ...
            <p className="text-xs text-[#737783] leading-relaxed max-w-xs mx-auto">
              ...
              <a className="text-on-surface-variant underline" href="#">
