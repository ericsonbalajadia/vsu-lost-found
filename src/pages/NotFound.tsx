...
export default function NotFound() {
  ...
  return (
    <div
      id="main-content"
      className="min-h-screen bg-[--color-surface] flex items-center
                    justify-center px-6"
    >
      ...
      <div className="fixed inset-0 -z-10 pointer-events-none overflow-hidden" aria-hidden="true">
        ...
        <div
          ...
          style={{
            background: 'color-mix(in srgb, var(--color-secondary-container) 10%, transparent)',
          }}
        />
      </div>
      ...
      <div className="text-center max-w-sm w-full">
        ...
        <div className="relative mb-8 select-none" aria-hidden="true">
          <span
            className="text-[9rem] font-black leading-none font-headline
        ...
        <h1
          className="text-3xl font-extrabold text-[--color-on-surface]
